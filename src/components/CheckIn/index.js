    ...
    return (
      <div className={classname(styles.container,this.props.className)}>
        <Row type="flex" justify="space-around" align="middle" style={{height:"100%"}}>
          <Col type="flex" align="middle" span="12" className={styles.center} >
              ...
              <Tab key="account" tab="账户密码登录">
                <Form onSubmit={this.onSubmit}>
                  ...
                  {getFieldDecorator('userName', {
                    ...
                    <Input size={'large'} prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder={this.props.userNamePlaceHolder} />
                  )}
                  </FormItem>
                  <FormItem>
